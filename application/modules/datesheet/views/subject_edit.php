    ...
    <div class="content-wrapper">
      ...
      <h3>
        ...
        if (empty($update_id)) 
                    ...
                    echo $strTitle;
                    ?>
                    <a href="<?php echo ADMIN_BASE_URL . 'datesheet/subjects/'.$this->uri->segment('4');?>"><button type="button" class="btn btn-primary btn-lg pull-right"><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;&nbsp;<b>Back</b></button></a>
       </h3>             
                ...
                <div class="portlet-body form " style="padding-top:15px;"> 
                  ...
                  <!-- BEGIN FORM-->
                        ...
                        if (isset($hidden) && !empty($hidden))
                            echo form_open_multipart(ADMIN_BASE_URL . 'datesheet/submit_subject_edit/' . $this->uri->segment('4').'/'. $this->uri->segment('5'), $hidden);
                        else
                            echo form_open_multipart(ADMIN_BASE_URL . 'datesheet/submit_subject_edit/' . $this->uri->segment('4').'/'. $this->uri->segment('5'), $attributes);
                        ?>
                  <div class="form-body">
                        ...
                        <div class="form-group">
                          <?php
                                                       ...
                                                       'value' => $news['start_time'],
                                                        ...
                                                        $attribute = array('class' => 'control-label col-md-4');
                                                        ?>
                          <?php echo form_label('Start Time<span style="color:red">*</span>', 'start_time', $attribute); ?>
                          <div class="col-md-8"> <?php echo form_input($data); ?> </div>
                        </div>
                      </div>
                      <div class="col-sm-5">
                    ...
                    <div class="col-md-6">
                      <div class="col-md-offset-2 col-md-9" style="padding-bottom:15px;">
                       <span style="margin-left:40px"></span> <button type="submit" id="button1" class="btn btn-primary"><i class="fa fa-check"></i>&nbsp;Save</button>
                        <a href="<?php echo ADMIN_BASE_URL . 'datesheet/subjects/'.$this->uri->segment('4'); ?>">
