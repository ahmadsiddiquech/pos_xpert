...
<div class="content-wrapper">
    <h3>Announcement<a href="announcement/create"><button type="button" class="btn btn-lg btn-primary pull-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;<b>Add Announcement</b></button></a></h3>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <table id="datatable1" class="table table-striped table-hover table-body">
                        ...
                        <th class="" style="width:400px;">Start Date</th>
                        <th class="" style="width:400px;">End Date</th>
                        ...
                        <tbody>
                                ...
                                if (isset($news)) {
                                    foreach ($news->result() as
                                            $new) {
                                        $i++;
                                        $set_publish_url = ADMIN_BASE_URL . 'announcement/set_publish/' . $new->id;
                                        $set_unpublish_url = ADMIN_BASE_URL . 'announcement/set_unpublish/' . $new->id ;
                                        $edit_url = ADMIN_BASE_URL . 'announcement/create/' . $new->id ;
                                        $delete_url = ADMIN_BASE_URL . 'announcement/delete/' . $new->id;
                                        ?>
                                    <tr id="Row_<?=$new->id?>" class="odd gradeX " >
                                        <td width='2%'><?php echo $i;?></td>
                                        <td><?php echo wordwrap($new->title)  ?></td>
                                        ...
                                        echo anchor($edit_url, '<i class="fa fa-edit"></i>', array('class' => 'action_edit btn blue c-btn','title' => 'Edit announcement'));

                                        echo anchor('"javascript:;"', '<i class="fa fa-times"></i>', array('class' => 'delete_record btn red c-btn', 'rel' => $new->id, 'title' => 'Delete announcement'));
                                        ?>
                                        </td>
                                    </tr>
                                    <?php } ?>    
...
$(document).ready(function(){
    ...
    /*//////////////////////// code for detail //////////////////////////*/
            ...
            //alert(id); return false;
              $.ajax({
                        type: 'POST',
                        url: "<?php ADMIN_BASE_URL?>announcement/detail",
                        data: {'id': id},
                        async: false,
    ...
    /*///////////////////////// end for code detail //////////////////////////////*/
          ...
          $(document).off('click', '.delete_record').on('click', '.delete_record', function(e){
                ...
                e.preventDefault();
              swal({
                title : "Are you sure to delete the selected announcement?",
                ...
                function () {
                       ...
                       $.ajax({
                            type: 'POST',
                            url: "<?php echo ADMIN_BASE_URL?>announcement/delete",
                            data: {'id': id},
                            async: false,
                            success: function() {
                            location.reload();
    ...
    /*///////////////////////////////// START STATUS  ///////////////////////////////////*/
        ...
        $(document).off("click",".action_publish").on("click",".action_publish", function(event) {
            ...
            var status = $(this).attr('status');
             $.ajax({
                type: 'POST',
                url: "<?= ADMIN_BASE_URL ?>announcement/change_status",
                ...
                success: function(result) {
                    ...
                    $("#listing").load('<?php ADMIN_BASE_URL?>announcement/manage');
