...
<div class="content-wrapper">
    ...
    <h3>Section<a href="sections/create"><button type="button" class="btn btn-lg btn-primary pull-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;<b>Add Section</b></button></a></h3>
                        ...
                        <tbody>
                                ...
                                if (isset($news)) {
                                    ...
                                    $std_url = ADMIN_BASE_URL . 'sections/std_list/' . $new->id.'/'.$new->section;
                                        ...
                                        $edit_url = ADMIN_BASE_URL . 'sections/create/' . $new->id ;

                                        $delete_url = ADMIN_BASE_URL . 'sections/delete/' . $new->id;
                                    ...
                                    <tr id="Row_<?=$new->id?>" class="odd gradeX " >
                                        ...
                                        <td><?php echo wordwrap($new->section , 50 , "<br>\n")  ?></td>
                                        ...
                                        echo anchor($edit_url, '<i class="fa fa-edit"></i>', array('class' => 'action_edit btn blue c-btn','title' => 'Edit sections'));



                                        echo anchor('"javascript:;"', '<i class="fa fa-times"></i>', array('class' => 'delete_record btn red c-btn', 'rel' => $new->id, 'title' => 'Delete sections'));
    ...
    /*//////////////////////// code for detail //////////////////////////*/
            ...
            //alert(id); return false;
              ...
              $.ajax({
                        ...
                        url: "<?php ADMIN_BASE_URL?>sections/detail",
    ...
    /*///////////////////////// end for code detail //////////////////////////////*/
          ...
          $(document).off('click', '.delete_record').on('click', '.delete_record', function(e){
              ...
              swal({
                ...
                title : "Are you sure to delete the selected sections?",
                ...
                function () {
                       ...
                       $.ajax({
                            ...
                            url: "<?php ADMIN_BASE_URL?>sections/delete",
                ...
                swal("Deleted!", "sections has been deleted.", "success");
        ...
        $(document).off("click",".action_publish").on("click",".action_publish", function(event) {
            ...
            var status = $(this).attr('status');
             ...
             $.ajax({
                ...
                url: "<?= ADMIN_BASE_URL ?>sections/change_status",
                ...
                success: function(result) {
                    ...
                    $("#listing").load('<?php ADMIN_BASE_URL?>sections/manage');
