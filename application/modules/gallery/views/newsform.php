    ...
    <div class="content-wrapper">
      ...
      <h3>
        ...
        if (empty($update_id)) 
                    ...
                    echo $strTitle;
                    ?>
                    <a href="<?php echo ADMIN_BASE_URL . 'gallery'; ?>"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-chevron-left"></i>&nbsp;&nbsp;&nbsp;Back</button></a>
       </h3>             
                ...
                <div class="portlet-body form " style="padding-top:15px;"> 
                  ...
                  <!-- BEGIN FORM-->
                        ...
                        if (isset($hidden) && !empty($hidden))
                            echo form_open_multipart(ADMIN_BASE_URL . 'gallery/submit/' . $update_id, $attributes, $hidden);
                        else
                            echo form_open_multipart(ADMIN_BASE_URL . 'gallery/submit/' . $update_id, $attributes);
                        ?>
                  <div class="form-body">
                     ...
                     <div class="col-sm-5">
                        <div class="form-group">
                          <?php
                                                        ...
                                                        $attribute = array('class' => 'control-label col-md-4');
                                                        ?>
                          <?php echo form_label('Event Date<span style="color:red">*</span> ', 'event_date', $attribute); ?>
                          <div class="col-md-8"> <?php echo form_input($data); ?> </div>
                        </div>
                      </div>
                    </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                    <? if (isset($news['image']) && !empty($news['image'])) {?>
                                                      <img src = "<?php echo base_url() . 'uploads/gallery/medium_images/' . $news['image'] ?>" />
                                                    <?php } else { ?>
                                            ...
                                            <div>
                                                <span class="btn default btn-file">
                                                    ...
                                                    <input type="file" name="make_image[]" id="make_image" class="dropify" value="<?php if(isset($news['image']) && !empty($news['image'])) echo $news['image'] ?>" data-max-file-size="2M" />
                                                    <input type="hidden" id="hdn_image" value="" name="hdn_image"/>
                                                </span>
