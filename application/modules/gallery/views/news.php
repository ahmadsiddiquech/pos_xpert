<div class="content-wrapper">
    <h3>Gallery<a href="gallery/create"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Event</button></a></h3>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <table id="datatable1" class="table table-striped table-hover table-body">
                        ...
                        <th style="width:400px;">Event Description</th>
                        <th class="" style="width:400px;">Event Date</th>
                        ...
                        <tbody>
                                ...
                                if (isset($news)) {
                                    ...
                                    <tr id="Row_<?=$new->id?>" class="odd gradeX " >
                                        ...
                                        <td><?php echo wordwrap($new->description)  ?></td>
                                        <td><?php echo $new->event_date ?></td>
                                        ...
                                        echo anchor($edit_url, '<i class="fa fa-edit"></i>', array('class' => 'action_edit btn blue c-btn','title' => 'Edit Event'));

                                        echo anchor('"javascript:;"', '<i class="fa fa-times"></i>', array('class' => 'delete_record btn red c-btn', 'rel' => $new->id, 'title' => 'Delete Event'));
                                        ?>
                                        </td>
                                    </tr>
                                    <?php } ?>    
