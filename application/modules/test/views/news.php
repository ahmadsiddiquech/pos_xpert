...
<div class="content-wrapper">
    <h3>Test<a href="test/create"><button type="button" class="btn btn-primary btn-lg pull-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;<b>Add Test</b></button></a></h3>
                        ...
                        <tbody>
                                ...
                                if (isset($news)) {
                                    ...
                                    <tr id="Row_<?=$new->id?>" class="odd gradeX " >
                                        ...
                                        <td><?php echo $new->charges ?></td>
                                        <td><?php echo $new->delivery_time ?></td>
...
$(document).ready(function(){
    ...
    var id = $(this).attr('rel');
      $.ajax({
            type: 'POST',
            url: "<?php echo ADMIN_BASE_URL?>test/detail",
            data: {'id': id},
            async: false,
