...
<div class="row" style="padding-left:40px;padding-bottom: 30px;padding-top: 30px;">
    <div class="col-md-3" onclick="location.href='product';">
        <div class="card text-white col-md-10 shadow" style="background-color: rgb(255, 189, 53); border-radius: 5px;">
            <div class="card-body ">
                <h3 class="card-text"><center>Total Product<br><?php echo $product; ?></center></h3>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3" onclick="location.href='supplier';">
        <div class="card text-white col-md-10 shadow" style="background-color: rgb(115, 96, 237); border-radius: 5px;">
            <div class="card-body">
                <h3 class="card-text"><center>Total Suppliers<br><?php echo $supplier; ?></center></h3>
            </div>
        </div>
    </div>
    <div class="col-md-3" onclick="location.href='sale_invoice';">
        <div class="card text-white col-md-10 shadow" style="background-color: rgb(85, 206, 101); border-radius: 5px;">
            <div class="card-body">
                <h3 class="card-text"><center>Total Invoices<br><?php echo $invoice; ?></center></h3>
            </div>
        </div>
    </div>
</div>
